                            ...
                            <div className="register-details">
                                <div className="register-input-info register-input-name">
                                    <div className="register-input_box r-l">
                                        <p>First Name</p>
                                        <input name="firstName" type="text" value={credentials.firstName} onChange={handleChange} placeholder="Enter your First Name" />
                                    </div>
                                    <div className="register-input_box r-r">
                                        <p>Last Name</p>
                                        <input name="lastName" type="text" value={credentials.lastName} onChange={handleChange} placeholder="Enter your Last Name" />
                                    </div>
                                </div>
                                <div className="register-input-info register-input-details">
                                    <div className="register-input_box r-l">
                                        <p>Phone Number</p>
                                        <input name="number" type="number" value={credentials.number} onChange={handleChange} placeholder="Enter your number" />
                                    </div>
                                    <div className="register-input_box r-r">
                                        <p>Email</p>
                                        <input name="email" type="email" value={credentials.email} onChange={handleChange} placeholder="Enter your email" />
                                    </div>
                                </div>
                                <div className="register-input-info register-input-pass">
                                    <div className="register-input_box r-l">
                                        <p>Password</p>
                                        <input name="password" type="password" value={credentials.password} onChange={handleChange} placeholder="Enter your password" />
                                    ...
                                    <div className="register-input_box r-r">
                                        ...
                                        <input name="confirmPassword" type="password" value={credentials.confirmPassword} onChange={handleChange} placeholder="Confirm your password" />
                                    </div>
                                </div>
                            </div>
